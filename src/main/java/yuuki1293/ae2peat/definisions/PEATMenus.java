...
public class PEATMenus extends MenuRegistry {
    ...
    public static final Supplier<MenuType<WPEATMenu>> WIRELESS_PATTERN_ENCODING_ACCESS_TERMINAL = create(
        "wireless_pattern_encoding_access_terminal",
        () -> WPEATMenu.TYPE);

    private static <M extends AEBaseMenu, H> Supplier<MenuType<M>> create(String id,
        MenuTypeBuilder.MenuFactory<M, H> factory, Class<H> host) {
